...
#ifndef ALQWARITZMI_MBASESOLVER_V2_H
#define ALQWARITZMI_MBASESOLVER_V2_H


#include "MinimumHittingSetSolver.h"

class MBaseSolverV2: public MinimumHittingSetSolver {
public:
...
#endif //ALQWARITZMI_MBaseSolverV2_H
